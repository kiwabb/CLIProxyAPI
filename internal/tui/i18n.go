...
var zhStrings = map[string]string{
	...
	"oauth_device_hint":  "  在浏览器中打开上述链接并输入设备码，完成后此界面会自动继续。",
...
var enStrings = map[string]string{
	...
	"oauth_device_hint":  "  Open the URL above in browser and enter the device code. This screen will continue automatically.",
